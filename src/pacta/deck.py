...
def render_deck(wallet_dir: str) -> str:
    ...
    return (
        ...
        "<p class='muted' style='font-size:.74rem'>Want the whole course, not "
        "just the tour? <a href='/manual' target='_top'>Open the lab "
        "manual</a> — sessions, drills, self-tests, capstone. Built to sit "
        "on one monitor while this deck flies on the other.</p>"
        "</aside></div>"
        "<script>"
        "(function(){"
